...
public class DailyStudentAdapter extends RecyclerView.Adapter<DailyStudentAdapter.VH> {
    private ArrayList<Student> listStudents = new ArrayList<>();
    private final Context ctx;

    public DailyStudentAdapter(Context ctx) {
        this.ctx = ctx;
    }
    ...
    public static class VH extends RecyclerView.ViewHolder {
        ...
        public void bind(Student student, Context ctx){
